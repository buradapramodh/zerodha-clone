...
function Footer() {
    return (<div className="container border-top mt-5" style={{backgroundColor:"rgba(240, 240, 240, 1) 240 240"}}>
        <div className="row mt-5">
            <div className="col">
                <img src='media/images/logo.svg'style={{width:"50%"}}/>
                <p className='text-muted fs-10'>&copy;2010 - 2025, Zerodha Broking Ltd.All rights reserved.</p>
            </div>
            <div className="col">
                <p>Company</p>
                <a href="">About</a><br/>
        ...
        <div className='container mt-5 text-muted' style={{fontSize:"11px"}}>
